...
output_cp = reference::raven_T_CB * reference::raven_T_B0[arm] * fwd_trans(0, 6, dh_alpha, dh_theta, dh_a, dh_d);
...
tf::Transform xf =  (reference::raven_T_CB * reference::raven_T_B0[arm]).inverse() * input_cp;
